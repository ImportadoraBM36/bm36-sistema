...
const totalVenda =
    (
        ...
        // veio da tela de venda já com o tipo de valor
        // (Cheio / Real / 1/3) aplicado — usamos ele direto
        ? valorFinal
        // fallback: nenhum valorFinal veio, calcula
        // só com o desconto (comportamento antigo)
        : Math.max(
            0,
            subtotalVenda -
            valorDesconto
