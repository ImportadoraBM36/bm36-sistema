...
const evento = pedido.evento && pedido.evento.nome && pedido.evento.id ? pedido.evento : null;
...
pdf.setFont('helvetica', 'bold');
pdf.setFontSize(9);
pdf.text('Evento: ' + (evento && evento.nome && evento.id ? `${evento.nome} (${evento.id})` : 'Não informado'), 130, 50);
